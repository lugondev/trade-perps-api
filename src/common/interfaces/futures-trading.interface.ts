...
export interface IFuturesTradingService extends IBaseTradingService {
	 ...
	 */
	setLeverage(params: SetLeverageParams): Promise<ApiResponse<{ leverage: number; symbol: string }>>;
	 ...
	 * Get funding history
	 */
	getFundingHistory(symbol: string, startTime?: number, endTime?: number, limit?: number): Promise<ApiResponse<any[]>>;
