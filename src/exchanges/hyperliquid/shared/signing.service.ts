...
// @ts-expect-error - package.json exports /signing but TypeScript may not resolve it correctly
...
export class SigningService {
   ...
   */
  async signL1Action(action: any, vaultAddress?: string, nonce?: number): Promise<SignedAction> {
